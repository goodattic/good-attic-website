...
const fourGuideAuthorityClusterPages = [
  buildResourcePage({
    ...
    faq_heading: "Frequently Asked Questions About Bat Guano and Attic Insulation",
    ...
    sections: [
      {
        ...
        items: [
          {
            title: "A single bat",
            text: "Seeing a bat outdoors does not suggest an attic problem by itself. A bat found inside, repeated activity around the roofline, guano near an opening, or evidence of an attic roost is a reason to inspect further."
          },
          {
            title: "A used roost",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "If physical contact with a bat may have occurred—or a bat was found in a room with someone who may not have noticed contact—contact the local health department and do not handle or release the bat until you receive guidance."
        ],
        layout: "panels",
        items: [
          {
      ...
      },
      {
        ...
        subcopy:
          "Bats can use small openings around rooflines, vents, chimneys, soffits, fascia, siding, and utility penetrations. The wildlife professional identifies active exits and proper closure timing. Roofing and attic crews can then repair the openings assigned to them without disrupting the wildlife plan.",
        paragraphs: [
      ...
      },
      {
        ...
        subcopy:
          "Good Attic handles insulation restoration after the wildlife and cleanup plan is clear. A wildlife professional handles active bats and exclusion timing, while specialized guano conditions may need a cleanup provider.",
        paragraphs: [
        ...
        items: [
          ...
          {
            title: "Specialized cleanup provider",
            text: "Leads when the guano amount, dust, containment, or other conditions require specialized equipment and cleanup controls."
          },
          {
            title: "Good Attic",
            text: "Removes affected insulation, prepares the attic, and installs fresh insulation after the wildlife and cleanup steps are ready."
          }
        ]
      },
      {
        eyebrow: "Cost and specialist conditions",
        heading: "Several parts of a bat-affected attic determine the final cost.",
        subcopy:
      ...
      },
      {
        ...
        heading: "Related Guides for Bat-Affected Attics",
        layout: "features",
        withImages: true,
        items: [
          {
            ...
            cta: "Identify contamination signs"
          },
          {
            url: "/resources/insulation-removal-vs-top-off/",
            title: "Insulation Removal vs Top-Off",
            kicker: "Insulation options",
            ...
            cta: "Compare insulation options"
          },
          {
            url: "/resources/replace-attic-insulation-when-replacing-roof/",
      ...
      },
      {
        ...
        heading: "Find Bat-Affected Attic Help Near You",
        subcopy:
          "Choose your market to learn how Good Attic can handle the insulation-restoration portion of a bat-affected attic alongside the appropriate wildlife professional.",
        layout: "features",
        withImages: true,
        items: [
          {
            url: "/salt-lake-city-ut/attic-pest-remediation/",
            title: "Bat-Affected Attic Insulation Help in Salt Lake City",
            kicker: "Salt Lake City",
            text: "Explore attic insulation restoration coordinated with a qualified wildlife professional in the Salt Lake City service area.",
            image: proofAssets.dirtyReset,
            alt: "Attic insulation restoration in Salt Lake City",
            cta: "View Salt Lake City services"
          },
          {
            url: "/st-louis-mo/attic-pest-remediation/",
            title: "Bat-Affected Attic Insulation Help in St. Louis",
            kicker: "St. Louis",
            text: "Explore attic insulation restoration coordinated with a qualified wildlife professional in the St. Louis service area.",
            image: proofAssets.dirtyReset,
            alt: "Attic insulation restoration in St. Louis",
            cta: "View St. Louis services"
          },
          {
            url: "/kansas-city-mo/attic-pest-remediation/",
            title: "Bat-Affected Attic Insulation Help in Kansas City",
            kicker: "Kansas City",
            text: "Explore attic insulation restoration coordinated with a qualified wildlife professional in the Kansas City service area.",
            image: proofAssets.dirtyReset,
            alt: "Attic insulation restoration in Kansas City",
            cta: "View Kansas City services"
          }
        ]
      }
    ],
    source_groups: [
      {
        ...
        sources: [
          ...
          {
            title: "CDC: Preventing Rabies From Bats",
            text: "Current public-health guidance on possible bat contact, situations in which contact may not have been noticed, and getting local health-department guidance before releasing the bat.",
  ...
  buildResourcePage({
    ...
    faq_heading: "Frequently Asked Questions About Wet Attic Insulation",
    suppress_related_links: true,
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Removal is more likely when the insulation is soaked, matted, smelly, contaminated, visibly damaged, or keeping the materials underneath from being inspected.",
      ...
      },
      {
        ...
        subcopy:
          "Water can move beyond the first damp spot, and surface dryness does not show whether the materials underneath are ready to cover.",
        paragraphs: [
          "Insulation may need to be lifted or removed so the roof deck, framing, ceiling, ductwork, drain pans, wiring, fixtures, and visible equipment can be evaluated. A roofer, plumber, HVAC contractor, electrician, mold professional, water-restoration company, structural professional, or another specialist may need to inspect or repair those materials before insulation work continues."
        ]
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            text: "Take out saturated, contaminated, smelly, matted, or damaged insulation, including material that prevents the attic below it from being checked."
          },
          {
      ...
      {
        eyebrow: "RELATED ATTIC GUIDES",
        heading: "Related Guides for Wet or Damaged Insulation",
        layout: "features",
        withImages: true,
        items: [
          {
            ...
            cta: "Learn about mouse remediation"
          },
          {
            url: "/resources/replace-attic-insulation-when-replacing-roof/",
            title: "Replace Attic Insulation With a New Roof?",
      ...
      {
        eyebrow: "LOCAL ATTIC HELP",
        heading: "Find Attic Insulation Removal Near You",
        subcopy:
          "Choose your market to learn about insulation removal and attic restoration after the source of the moisture has been addressed.",
        layout: "features",
        withImages: true,
        items: [
          {
            url: "/salt-lake-city-ut/insulation-removal/",
            title: "Wet Attic Insulation Removal in Salt Lake City",
            kicker: "Salt Lake City",
            text: "See how damaged insulation can be removed, leaving a cleaner, properly prepared attic.",
            image: proofAssets.removal,
            alt: "Attic insulation removal in Salt Lake City",
            cta: "View Salt Lake City services"
          },
          {
            url: "/st-louis-mo/insulation-removal/",
            title: "Wet Attic Insulation Removal in St. Louis",
            kicker: "St. Louis",
            text: "See how damaged insulation can be removed after the moisture source and related repairs are addressed.",
            image: proofAssets.removal,
            alt: "Attic insulation removal in St. Louis",
            cta: "View St. Louis services"
          },
          {
            url: "/kansas-city-mo/insulation-removal/",
            title: "Wet Attic Insulation Removal in Kansas City",
            kicker: "Kansas City",
            text: "See how damaged insulation can be removed after the moisture source and related repairs are addressed.",
            image: proofAssets.removal,
            alt: "Attic insulation removal in Kansas City",
            cta: "View Kansas City services"
          }
        ]
      }
    ...
    source_groups: [
      {
        ...
        sources: [
          ...
          },
          {
            ...
            text: "Technical guidance for checking roof leaks, wet materials, pests, wiring, framing, ventilation, equipment, and other conditions that should be addressed before attic work.",
    ...
    cta: {
      title: "Need Help With Wet Attic Insulation?",
  ...
  buildResourcePage({
    ...
    faq_heading: "Frequently Asked Questions About Roof Replacement and Attic Insulation",
    suppress_related_links: true,
    ...
    faq_items: [
      ...
      },
      {
        ...
        answer:
          "Some roofing companies may offer adjacent services, but roofing and attic restoration are different kinds of work. Make sure the quotes explain who is responsible for removal, cleanup, air sealing, baffles, and final insulation."
      },
      {
    ...
    hero: {
      ...
      cardKicker: "Inspect before the roofing plan is final",
    ...
    sections: [
      ...
      },
      {
        ...
        heading: "Inspect the attic before the roofing plan is finalized.",
        subcopy:
      ...
      },
      {
        ...
        paragraphs: [
          "The roofer handles roofing, flashing, decking, and other work that corrects the roof source. Another specialist may need to address mold, electrical, structural, HVAC, plumbing, or drying concerns. Good Attic can remove damaged insulation and prepare the attic after the source and related work are addressed."
        ],
        layout: "tiles",
        items: [
          {
          ...
          },
          {
            ...
            text: "Make sure each contractor's quote clearly explains who is responsible for every part of the project."
          }
        ]
      },
      {
        ...
        items: [
          {
            title: "Mouse entry",
            text: "Handle the active mouse problem first, then coordinate which contractor will close each roofline or attic opening."
          },
          {
            title: "Bat entry",
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: "Good Attic",
            text: "Handles the attic side: inspecting existing insulation, removing damaged or contaminated material, cleaning and preparing the space, and installing fresh blown-in cellulose when ready."
          },
          {
            title: "Another appropriate professional",
            text: "May handle active wildlife exclusion, plumbing, HVAC, electrical, structural, mold, formal drying, asbestos, or another specialized condition."
          }
        ]
      },
      {
        ...
        subcopy:
          "The roofer and attic contractor should agree on the sequence before either crew closes an area the other still needs to reach.",
        layout: "tiles",
        items: [
          {
          ...
          },
          {
            ...
            text: "Resolve wildlife timing, hazardous materials, and urgent electrical or structural concerns before related attic work continues."
          },
          {
          ...
          {
            title: "4. Complete the roof work",
          ...
          },
          {
            ...
            text: "Complete the removal, cleanup, air sealing, baffle, ventilation, and entry-point work in the agreed order."
          },
          {
      ...
      {
        eyebrow: "RELATED ATTIC GUIDES",
        heading: "Related Guides for Roof and Attic Planning",
        layout: "features",
        withImages: true,
        items: [
          {
          ...
          },
          {
            ...
            kicker: "Bat exclusion",
            text: "Understand exclusion timing, guano cleanup, and roofline closure when bats have used the attic.",
            image: proofAssets.dirtyReset,
            alt: "Attic restoration planning after bat activity",
            cta: "Learn about bat-affected attics"
          },
          {
            url: "/resources/wet-attic-insulation-remove-or-dry/",
      ...
      {
        eyebrow: "LOCAL ATTIC HELP",
        heading: "Find Attic Insulation Help Near You",
        subcopy:
          "Choose your market to learn about attic insulation, removal, air sealing, and preparation that can be coordinated with a roofing project.",
        layout: "features",
        withImages: true,
        items: [
          {
            url: "/salt-lake-city-ut/attic-insulation/",
            title: "Roof and Attic Insulation Planning in Salt Lake City",
            kicker: "Salt Lake City",
            text: "Learn about attic insulation, removal, air sealing, and preparation that can be coordinated with a Salt Lake City roofing project.",
            image: proofAssets.insulation,
            alt: "Attic insulation planning in Salt Lake City",
            cta: "View Salt Lake City services"
          },
          {
            url: "/st-louis-mo/attic-insulation/",
            title: "Roof and Attic Insulation Planning in St. Louis",
            kicker: "St. Louis",
            text: "Learn about attic insulation, removal, air sealing, and preparation that can be coordinated with a St. Louis roofing project.",
            image: proofAssets.insulation,
            alt: "Attic insulation planning in St. Louis",
            cta: "View St. Louis services"
          },
          {
            url: "/kansas-city-mo/attic-insulation/",
            title: "Roof and Attic Insulation Planning in Kansas City",
            kicker: "Kansas City",
            text: "Learn about attic insulation, removal, air sealing, and preparation that can be coordinated with a Kansas City roofing project.",
            image: proofAssets.insulation,
            alt: "Attic insulation planning in Kansas City",
            cta: "View Kansas City services"
          }
        ]
      }
  ...
  buildResourcePage({
    ...
    faq_heading: "Frequently Asked Questions About Mice and Attic Insulation",
    suppress_related_links: true,
    ...
    sections: [
        ...
        items: [
          {
            ...
            text: "A pest professional should address active mice before attic restoration begins. Good Attic can coordinate that work when needed."
          },
          {
      ...
      },
      {
        ...
        subcopy:
          "The work should move from active mouse control and home protection to removal, cleanup, sealing, attic preparation, and fresh insulation.",
        layout: "tiles",
        items: [
          {
          ...
          },
          {
            ...
            text: "Remove the existing insulation and pest debris. The old insulation, droppings, nests, and other debris come out instead of being covered."
          },
          {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Some attics uncover electrical, structural, HVAC, or hazardous-material concerns that need another qualified professional before restoration can continue."
        ],
        layout: "tiles",
        items: [
          {
      ...
      },
      {
        ...
        paragraphs: [
          "Removing the old insulation exposes the attic floor so it can be cleaned, inspected, sealed, and prepared before fresh insulation is installed. The final plan should reflect what the inspection finds."
        ]
      },
      {
        eyebrow: "RELATED ATTIC GUIDES",
        heading: "Related Guides for Mouse-Damaged Attics",
        layout: "features",
        withImages: true,
        items: [
          {
      ...
      {
        eyebrow: "LOCAL ATTIC HELP",
        heading: "Find Pest-Damaged Attic Help Near You",
        subcopy:
          "Choose your market to learn about mouse-contaminated insulation removal, attic cleanup, entry-point work, and full attic remediation.",
        layout: "features",
        withImages: true,
        items: [
          {
            url: "/salt-lake-city-ut/attic-pest-remediation/",
            title: "Mouse-Contaminated Attic Help in Salt Lake City",
            kicker: "Salt Lake City",
            text: "Learn about removing mouse-contaminated insulation, cleaning and preparing the attic, closing entry points, and installing fresh insulation in the Salt Lake City service area.",
            image: proofAssets.pestDamage,
            alt: "Mouse-damaged attic restoration in Salt Lake City",
            cta: "View Salt Lake City services"
          },
          {
            url: "/st-louis-mo/attic-pest-remediation/",
            title: "Mouse-Contaminated Attic Help in St. Louis",
            kicker: "St. Louis",
            text: "Learn about removing mouse-contaminated insulation, cleaning and preparing the attic, closing entry points, and installing fresh insulation in the St. Louis service area.",
            image: proofAssets.pestDamage,
            alt: "Mouse-damaged attic restoration in St. Louis",
            cta: "View St. Louis services"
          },
          {
            url: "/kansas-city-mo/attic-pest-remediation/",
            title: "Mouse-Contaminated Attic Help in Kansas City",
            kicker: "Kansas City",
            text: "Learn about removing mouse-contaminated insulation, cleaning and preparing the attic, closing entry points, and installing fresh insulation in the Kansas City service area.",
            image: proofAssets.pestDamage,
            alt: "Mouse-damaged attic restoration in Kansas City",
            cta: "View Kansas City services"
          }
        ]
      }
...
function renderPage(page) {
  ...
  const scriptHref = `${assetHref(currentUrl, "script.js")}?v=measurement-20260901a`;
