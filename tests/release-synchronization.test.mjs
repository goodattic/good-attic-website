...
test("the current release changes only the exact approved broker patch, focused tests and two release guards", () => {
  const allowed = new Set(["PHASE2-GOOGLE-ADS-OUTCOME-WATCHER.md", "outputs/phase2-dry-run-reconciliation-2026-09-21.json", "tests/approved-operational-hashes.mjs", "tests/live-backend-parity.mjs", "tests/release-synchronization.test.mjs", "server/acknowledgement-source.js", "server/google-ads-outcome-collection.js", "server/google-ads-outcome-watcher.js", "server/jobber-acknowledgement-resolver.js", "server/jobber-contact-resolver.js", "server/jobber-quo-intake.js", "server/jobber-alert-resolver.js", "server/jobber-auth-health.js", "server/quo-client-name.js", "functions/api/jobber/acknowledgement-resolve.js", "functions/api/jobber/alert-resolve.js", "functions/api/jobber/contact-resolve.js", "functions/api/jobber/oauth/health.js", "functions/api/jobber/quo-intake-note.js", "functions/api/jobber/quo-intake-resolve.js", "functions/api/jobber/quo-intake-status.js", "functions/api/jobber/quo-intake-write.js", "functions/i/[token].js", "wrangler.toml", "tests/fixtures/acknowledgement-sources.sql", "tests/fixtures/quo-intake-operations.sql", "tests/google-ads-outcome-watcher.test.mjs", "tests/jobber-acknowledgement-resolver.test.mjs", "tests/jobber-quo-intake.test.mjs", "tests/live-backend-parity.mjs", "tests/quo-client-name.test.mjs", "tests/jobber-auth-health.test.mjs", "migrations/0008_quo_call_attributions.sql", "migrations/0009_google_ads_outcome_outbox.sql", "migrations/0010_relax_quo_call_upload_status.sql"]);
